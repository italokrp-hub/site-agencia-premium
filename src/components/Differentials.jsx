...
const Differentials = () => {
  ...
  return (
    <section id="diferenciais" className="py-12 md:py-20 bg-gradient-to-b from-[#F7F3E9] to-white overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Trust Badge */}
          <div className="inline-flex items-center gap-2 bg-white px-3 md:px-4 py-1.5 md:py-2 rounded-full shadow-sm border border-gray-200 text-[#2C7A7B] text-xs md:text-sm font-semibold">
            <CheckCircle2 className="w-3.5 h-3.5 md:w-4 md:h-4" />
            <span className="hidden sm:inline">Empresa Certificada </span>CADASTUR: 51.790.615/0001-08
          </div>
        </motion.div>

        <div className="flex flex-nowrap md:grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 max-w-7xl mx-auto overflow-x-auto snap-x snap-mandatory no-scrollbar pb-6 md:pb-0 -mx-4 px-4 md:mx-auto md:px-0">
        ...
        >
          <div className="inline-flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 bg-white rounded-2xl px-6 md:px-8 py-5 md:py-6 shadow-lg">
            <div className="text-center px-2">
              <div className="text-2xl md:text-3xl font-bold text-[#2C7A7B] mb-1">100%</div>
              <div className="text-xs md:text-sm text-gray-600">Segurança</div>
            </div>
            <div className="text-center px-2">
              <div className="text-2xl md:text-3xl font-bold text-[#2C7A7B] mb-1">24h</div>
              <div className="text-xs md:text-sm text-gray-600">Suporte</div>
            </div>
            <div className="text-center px-2">
              <div className="text-2xl md:text-3xl font-bold text-[#2C7A7B] mb-1">5.0</div>
              <div className="text-xs md:text-sm text-gray-600">Avaliação</div>
            </div>
            <div className="text-center px-2">
              <div className="text-2xl md:text-3xl font-bold text-[#2C7A7B] mb-1">Top</div>
